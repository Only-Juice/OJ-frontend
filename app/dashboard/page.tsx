      ...
      try {
        const response = await fetch("https://ojapi.ruien.me/api/score/all", {
          headers: {
            ...
            Authorization:
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjozLCJ1c2VybmFtZSI6Ik1yRHJhZ29uIiwiaXNfYWRtaW4iOnRydWV9.cfd0dozROLstEk85w2UXAfNKYkD0x0hqRPS8AEJaeac",
          },
        });
